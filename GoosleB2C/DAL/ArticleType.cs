...
namespace GoosleB2C.DAL
{
	...
	public partial class ArticleType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "ArticleType"); 
		}
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(GoosleB2C.Model.ArticleType model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(GoosleB2C.Model.ArticleType model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public GoosleB2C.Model.ArticleType GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,typeName from ArticleType ");
			strSql.Append(" where id=@id ");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
			parameters[0].Value = id;

			GoosleB2C.Model.ArticleType model=new GoosleB2C.Model.ArticleType();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ArticleType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ArticleType";
