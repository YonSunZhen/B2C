...
namespace GoosleB2C.DAL
{
	...
	public partial class Article
	{
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(GoosleB2C.Model.Article model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Article(");
            strSql.Append("Id,type,state,title,orders,webContent,content,imgs,readCount,remark,creator,createTime,modifier,modifyDate,seoTitle,seoKey,seoDescribe)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(GoosleB2C.Model.Article model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            parameters[4].Value = model.webContent;
            ...
            parameters[14].Value = model.seoKey;
            parameters[15].Value = model.seoDescribe;
        ...
        /// 得到一个对象实体
        /// </summary>
        public GoosleB2C.Model.Article GetModel(string Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,type,state,title,orders,webContent,content,imgs,readCount,remark,creator,createTime,modifier,modifyDate,seoTitle,seoKey,seoDescribe from Article ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
                    new SqlParameter("@Id", SqlDbType.VarChar,36)};
            parameters[0].Value = Id;

            GoosleB2C.Model.Article model = new GoosleB2C.Model.Article();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,type,state,title,orders,webContent,content,imgs,readCount,remark,creator,createTime,modifier,modifyDate,seoTitle,seoKey,seoDescribe ");
