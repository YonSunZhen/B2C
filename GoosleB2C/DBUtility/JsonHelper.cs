...
namespace GoosleB2C.DBUtility
{
    ...
    public class JsonHelper
    {
        ...
        public static string CreateJsonTwo(DataTable dt, bool displayCount)
        {
            ...
            {
                //JsonString.Append("[");
                //for (int i = 0; i < dt.Rows.Count-1; i++)//有多少条数据
                //{                  
                //    JsonString.Append("{"+ "\"" + "id" + "\"" + ":"+ (i+1) +",");
                //    JsonString.Append("\"" + "text" + "\"" + ":" + "\"" + dt.Rows[i][0].ToString() + "\"");
                //    JsonString.Append("}"+",");    
                //}
                //JsonString.Append("{");
                //int j = dt.Rows.Count-1;
                //JsonString.Append("\"" + "id" + "\"" + ":" + (j + 1) + ",");
                //JsonString.Append("\"" + "text" + "\"" + ":" + "\"" + dt.Rows[j][0].ToString() + "\"");
                //JsonString.Append("}");
                //JsonString.Append("]");
                //return JsonString.ToString();
                JsonString.Append("[");
