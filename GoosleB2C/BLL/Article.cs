...
namespace GoosleB2C.BLL
{
	...
	{
		private readonly GoosleB2C.DAL.Article dal=new GoosleB2C.DAL.Article();
		public Article()
		{}
        #region  Method
        /// <summary>
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public GoosleB2C.Model.Article GetModelByCache(string Id)
        {
            ...
            return (GoosleB2C.Model.Article)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<GoosleB2C.Model.Article> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<GoosleB2C.Model.Article> DataTableToList(DataTable dt)
        {
            List<GoosleB2C.Model.Article> modelList = new List<GoosleB2C.Model.Article>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                GoosleB2C.Model.Article model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new GoosleB2C.Model.Article();
