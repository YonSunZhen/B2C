...
function addImage(targetObj, originalSrc, thumbSrc) {
    ...
    + '</div>'
    + '<select panelMaxHeight="200px" panelHeight="auto" editable="false">'
    + '<option value="0",selected="selected">未选择</option>'
    + '<option value="1">产品</option>'
    + '<option value="2">案例</option>'
    + '<option value="3">文章</option>'
    + '</select>'
    + '<input class="ID" name="ID" value="" placeholder="请输入id值"'
    + '</li>');
...
function Del() {
    var arry_size = arry.length - 1;
    for (var i = 0; i < arry_size;) {
