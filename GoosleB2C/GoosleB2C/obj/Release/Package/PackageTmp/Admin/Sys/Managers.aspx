<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Managers.aspx.cs" Inherits="GoosleB2C.Web.Admin.Sys.Managers" %>
...
<body>
    ...
    <div id="edit" class="easyui-dialog" title="" style="width: 400px; height: 350px;"
        modal="true" closed="true" closable="false" resizable="true" buttons="#edit-buttons">
          <form id="form_edit" name="form_edit" method="post" url="Managers.aspx">
        <table class="table_edit">
            ...
            <tr>
                ...
                <td class="tdar tdar_">
                    <input id="ipt_cnname" name="ipt_cnname" type="text" class="easyui-validatebox"
            ...
            <tr>
                ...
                <td class="tdar tdar_">
                    <input id="ipt_mobile" name="ipt_mobile" type="text" class="easyui-validatebox" data-options="required:'true',validType:'phone'"/>
                </td>
            </tr>
            <tr>
                <td class="tdal tdal_">
                ...
                <td class="tdar tdar_">           
                        ...
                        <option value="-2">禁止用户</option>
                        <option value="-1">删除用户</option>
                        <option value="0">未通过用户</option>
            ...
            <tr>
                ...
                <td class="tdar tdar_">           
                        <select id="ipt_roleid" class="easyui-combobox" name="ipt_roleid" editable="false" style="width:175px;">                            
                        </select>
                </td>
            </tr>                       
            <tr>
                ...
                <td class="tdar tdar_">           
                        <select id="ipt_usertype" class="easyui-combobox" name="ipt_usertype" editable="false" style="width:175px;">
                        <option value="1">普通管理</option>
                        <option value="9">高级管理</option>                       
                        </select>
                </td>
            </tr>
            <tr>
        ...
        function InitGird() {
            $('#tab_list').datagrid({
                ...
                columns: [[
                    ...
                    { title: '创建时间', field: 'JSON_cteatedate', width: 150 },
                    { title: '创建人', field: 'JSON_creator', width: 150 },
                    { title: '登录时间', field: 'JSON_logindate', width: 150 },
                    { title: '上次登录时间', field: 'JSON_lastlogindate', width: 150 },
                    { title: '登录次数', field: 'JSON_logintimes', width: 150 },
                    { title: '备注', field: 'JSON_remark', width: 150, formatter: transForm},
                    { title: '扩展1', field: 'JSON_expand1', width: 150 },
                    {
